  ...
  en: {
    ...
    dash: {
      ...
      inbox: {
        ...
        emptyHint: "Contact & feedback forms from your sites land here — no email needed.",
  ...
  ru: {
    ...
    dash: {
      ...
      inbox: {
        ...
        emptyHint: "Сюда попадают заявки из форм обратной связи на ваших сайтах — без почты.",
  ...
  uz: {
    ...
    dash: {
      ...
      inbox: {
        ...
        emptyHint: "Сайтларингиздаги алоқа формаларидан хабарлар шу ерга тушади — почтасиз.",
