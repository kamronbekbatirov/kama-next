...
export const translations = {
  en: {
    ...
    dash: {
      ...
      loading: "Loading...",
      settings: "Settings",
      tabs: { today: "Today", tasks: "Tasks", jobs: "Jobs", server: "Server", analytics: "Stats", budget: "Budget", journal: "Journal", learn: "Learn", log: "Log", notes: "Notes", history: "History" },
      today: {
        now: "Now",
        schedule: "Schedule",
        prayers: "Prayers",
  ...
  ru: {
    ...
    dash: {
      ...
      loading: "Загрузка...",
      settings: "Настройки",
      tabs: { today: "Сегодня", tasks: "Задачи", jobs: "Работа", server: "Сервер", analytics: "Трафик", budget: "Бюджет", journal: "Журнал", learn: "Знания", log: "Лог", notes: "Заметки", history: "История" },
      today: {
        now: "Сейчас",
        schedule: "Расписание",
        prayers: "Намаз",
  ...
  uz: {
    ...
    dash: {
      ...
      loading: "Юкланмоқда...",
      settings: "Созламалар",
      tabs: { today: "Бугун", tasks: "Вазифалар", jobs: "Иш", server: "Сервер", analytics: "Трафик", budget: "Бюджет", journal: "Журнал", learn: "Билим", log: "Лог", notes: "Эслатмалар", history: "Тарих" },
      today: {
        now: "Ҳозир",
        schedule: "Жадвал",
        prayers: "Намоз",
